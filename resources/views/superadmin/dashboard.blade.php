    ...
    <div class="p-4">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                <div
                    class="w-full p-4 sm:p-6 bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <!-- Percentage Badge -->
                        <div
                            class="flex items-center px-2 py-1 sm:px-3 sm:py-1 bg-green-100 dark:bg-green-900/30 rounded-full">
                    ...
                    <div
                        class="flex items-center text-xs sm:text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">
