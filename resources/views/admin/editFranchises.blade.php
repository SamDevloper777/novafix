...
<div class="container mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Franchise</h1>
    <!-- Stepper -->
    ...
    <form action="{{ route('admin.update',$franchise->id) }}" method="POST" class="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="franchise_name" placeholder="Franchise name..."
                            id="franchise_name" value="{{old('franchise_name',$franchise->franchise_name)}}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="contact_no" id="contact_no" placeholder="+91XXXXXXXX"
                            value="{{ old('contact_no',$franchise->contact_no) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="aadhaar_no" id="aadhaar_no" placeholder="Aadhaar number..."
                            value="{{ old('aadhaar_no',$franchise->aadhaar_no) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="pan_no" id="pan_no" placeholder="PAN number..."
                            value="{{ old('pan_no',$franchise->pan_no) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="doc" class="block text-gray-700 text-sm font-semibold mb-2">Date of
                            Creation (DOC)</label>
                        <input type="date" name="doc" id="doc" value="{{ old('doc',$franchise->doc) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" value="{{old('password',$franchise->password)}}" placeholder="Password (8+ characters)" id="password"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="pincode" id="pincode" placeholder="Pincode"
                            value="{{ old('pincode',$franchise->pincode) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="street" placeholder="Street address" id="street"
                            value="{{ old('street',$franchise->street) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="country" placeholder="India" value="{{ old('country',$franchise->country) }}" id="country"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="state" placeholder="Bihar" value="{{ old('state',$franchise->state) }}" id="state"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight"
                            readonly>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="district" placeholder="Purnea" value="{{ old('district',$franchise->district) }}" id="district"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight"
                            readonly>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="city" placeholder="Purnea" value="{{ old('city',$franchise->city) }}" id="city"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight"
                            readonly>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="ifsc_code" id="ifsc_code" placeholder="IFSC Code"
                            value="{{ old('ifsc_code',$franchise->ifsc_code) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="account_no" id="account_no" placeholder="Account number"
                            value="{{ old('account_no',$franchise->account_no) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="bank_name" class="block text-gray-700 text-sm font-semibold mb-2">Bank
                            Name</label>
                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name',$franchise->bank_name) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight"
                            readonly>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="branch_name" id="branch_name"
                            value="{{ old('branch_name',$franchise->branch_name) }}"
                            class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight"
                            readonly>
                    </div>
                </div>
        ...
        <div>
            ...
            <div class="mt-6 flex justify-between">
                ...
                <button type="submit"
                    class="btn-submit bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded hidden">Edit
                    Franchise</button>
            </div>
